...
/* store.c */
void store_entry _ANSI_ARGS_ ((char **values, int size, int position, char *default_value));
...
EXTERN xmlTextWriterPtr xml_writer;
...
EXTERN char *Output_Wtrkinfo_Filename;
